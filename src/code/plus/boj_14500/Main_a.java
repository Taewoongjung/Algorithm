...
public class Main_a {
    ...
    public static void main(String[] args) throws IOException {
        System.out.println(polynominos.length);
        System.out.println(polynominos[0].length);
        System.out.println(polynominos[0][0].length);
        System.out.println(polynominos[0][1][1]);
